...
const char *built_in_commands[] = {"cd", "pwd", "help", "export", "set", "unset", "env", "history",  NULL};
    ...
    for (int i = 0; built_in_commands[i] != NULL; i++) {
        if (strcmp(cmd->argv[0], built_in_commands[i]) == 0) {
            ...
            if (strcmp(cmd->argv[0], "help") == 0) {
                ...
                printf("   export [VAR] [VALUE] - Export a variable\n");
                printf("   set [VAR] [VALUE] - Set a variable\n");
                printf("   unset [VAR] - Unset a variable\n");
